...
(function (global) {
  ...
  function validateKeyFormat(input) {
    ...
    return { valid: true, key: key, durationDays: opt.days };
  }
  ...
  // Ativa uma chave neste dispositivo. Uma chave já utilizada e expirada
  // neste dispositivo não pode ser reativada.
  function activate(input) {
    ...
    expiresAt.setDate(expiresAt.getDate() + check.durationDays);
